...
def escena_1():
    ...
    dibujar_dunas()
    caballo()
    print(f"Una vez, en un mundo mágico, vivía un niño llamado, {nombre}. {nombre} tenía {edad} años y su color favorito era {colordibujar_triangul} vivía en un mundo lleno de colores. Un día, mientras paseaba por el desierto cercano a su casa se encontro con su compañero de vida el camello Bartomeu, quien siempre lo acompañaba a todos lados,")
